...
fn raw_value() {
    ...
    // add ` unwrap()` to make this work
    let icecreams = maybe_icecream(12_usize).unwrap();
    assert(icecreams == 5_usize, 'err_6');

    // four tests below is me playing around
    // assert(maybe_icecream(13_usize).unwrap() == 5_usize, 'err_2');
    // assert(maybe_icecream(23_usize).unwrap() == 0_usize, 'err_3');
    // assert(maybe_icecream(30_usize).unwrap() == 5_usize, 'err_2'); //this fails
    // assert(maybe_icecream(25_usize).unwrap() == 0_usize, 'err_3');// this fails
